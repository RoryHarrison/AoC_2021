...
fn
solve(input: &Vec<Line>, allow_diagonals: bool) -> i64 {
    let mut points: Vec<Vec2> = vec!();
    ...
    let
        ...
        Vec<Vec2>
        =
        points.into_iter().duplicates().collect();
...
tests {
    ...
    #[test]
    fn
        test_horizontal_line_creation() {
            let line5 = parse_input("0,0 -> 4,0");
            let
                line5_vec
                =
                create_line(&line5[0],false);
    ...
    #[test]
    fn
        test_diagonal_line_creation() {
            let lines = parse_input("7,9 -> 9,7");
            let
                line_vec
                =
                create_line(&lines[0],false);
            assert_eq!(line_vec.len(), 0);

            let
                line_vec_diag
                =
                create_line(&lines[0],true);
            assert_eq!(line_vec_diag.len(), 3);
    }

    #[test]
    fn
        test_vertical_line_creation() {
    ...
    #[test]
    fn
        test_invalid_line_creation() {
            let line = parse_input("0,4 -> 4,0");
            let
                line_vec
                =
                create_line(&line[0],false);
